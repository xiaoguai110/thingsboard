...
public class DeviceController extends BaseController {
    ...
    public Device saveDevice(@RequestBody Device device) throws ThingsboardException {
        try {
            ...
            System.out.println("savedDevice1="+savedDevice);
    ...
    public TextPageData<Device> getTenantDevices(
        ...
        try {
            ...
            if (type != null && type.trim().length() > 0) {
                TextPageData<Device> devices = deviceService.findDevicesByTenantIdAndType(tenantId, type, pageLink);
    ...
    public TextPageData<Device> getCustomerDevices(
        ...
        try {
            ...
            TextPageLink pageLink = createPageLink(limit, textSearch, idOffset, textOffset);
            if (type != null && type.trim().length() > 0) {
                TextPageData<Device> devices = deviceService.findDevicesByTenantIdAndCustomerIdAndType(tenantId, customerId, type, pageLink);
                System.out.println("device="+devices);
